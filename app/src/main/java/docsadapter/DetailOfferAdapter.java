 ...
 */
public class DetailOfferAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_detail_offer, null);
    ...
    public class AnswerViewHolder extends RecyclerView.ViewHolder{
        ...
        public AnswerViewHolder(View itemView) {
            ...
            this.headImg = (ImageView) itemView.findViewById(R.id.img_head);
        }
    }
}
